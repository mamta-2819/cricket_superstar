...
<style>
    .single-matches-box .matches-teams::after{
        content:'VS';
    }
</style>
       <!-- Start Matches Area -->
            ...
            <div class="container">
                ...
                <div class="matches-tabs">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation"><a class="nav-link active" id="all-matches-tab" data-bs-toggle="tab" href="#all-matches" role="tab" aria-controls="all-matches" aria-selected="true">Upcomming</a></li>
    
                        <li class="nav-item" role="presentation"><a class="nav-link" id="upcoming-matches-tab" data-bs-toggle="tab" href="#upcoming-matches" role="tab" aria-controls="upcoming-matches" aria-selected="false">Live</a></li>
    
                        <li class="nav-item" role="presentation"><a class="nav-link" id="latest-result-tab" data-bs-toggle="tab" href="#latest-result" role="tab" aria-controls="latest-result" aria-selected="false">Finished</a></li>
                    </ul>
                        ...
                        <div class="tab-pane fade show active" id="all-matches" role="tabpanel">
                            ...
                            <div class="single-matches-box">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-5 col-md-12">
                                        <div class="matches-team right-image matches-teams">
